...
public class BaseResidentService implements ResidentService {
  ...
  /**
   * @param filterResident nimmt einen Resident als Angabe zu der Suche entgegen
   * @return ein Resident
   * @throws ResidentServiceException nur bei keinem Ergebnis und bei Wildcards in der Suchanfrage
   */
  ...
  /**
   * @param filterResident nimmt ein Objekt entgegen des Typs Resident
   * @return Eine Liste aus Objekten des Typs Resident, leer oder gefuellt
   */
